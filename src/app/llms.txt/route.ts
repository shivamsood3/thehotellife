...
export function GET() {
  const lines = [
    ...
    link("How we review", "/how-we-review", "Personal experience, fact checking, independence and scoring."),
    link("Zinnia Thapar", "/authors/zinnia-thapar", "Editor and travel writer; profile and published hotel reviews."),
