...
export async function generateMetadata({
  ...
  return {
    title: `Best Luxury Hotels in ${dest.name} (2026)`,
    ...
    <div className="pb-8">
      ...
      <div className="relative mt-6 overflow-hidden rounded-md">
        <div className="relative aspect-[3/4] w-full sm:aspect-[16/6]">
          <Image src={dest.heroImage} alt={`Hotels and places to stay across ${dest.name}`} fill preload className="object-cover" sizes="100vw" />
